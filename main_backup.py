...
def create_desktop_shortcuts():
    """No longer needed - folders are directly on desktop"""
    first_run_flag = ORGANIZER / ".blamite_first_run"
    ...
    print("\n" + "="*50)
    print("🎯 FIRST-TIME SETUP: Organizing folders on Desktop")
    print("="*50)
    print("✅ BLAMITE_Organizer folder created directly on your Desktop!")
    print("   All organized files will be easily accessible from:")
    print(f"   📁 {ORGANIZER}")
    print("   ")
    print("   Subfolders created:")
    for name, folder in [("PDFs", SUBFOLDERS["pdf"]), 
                        ("Word Documents", SUBFOLDERS["doc"]), 
                        ("Excel Files", SUBFOLDERS["xls"])]:
        print(f"   � {name}: {folder}")
